...
| ------------------------- | ------------------------- | ------------------------- |
| models.ClerkErrorsError58 | 422                       | application/json          |
...
| Error Type                | Status Code               | Content Type              |
| ------------------------- | ------------------------- | ------------------------- |
| models.ClerkErrorsError59 | 402, 422                  | application/json          |
| models.SDKError           | 4XX, 5XX                  | \*/\*                     |
...
| Error Type                | Status Code               | Content Type              |
| ------------------------- | ------------------------- | ------------------------- |
| models.ClerkErrorsError61 | 402, 404, 422             | application/json          |
| models.SDKError           | 4XX, 5XX                  | \*/\*                     |