    ...
    def list_allowlist_identifiers(
        ...
        *,
        ...
        if utils.match_response(http_res, ["401", "402"], "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsError45Data)
            raise models.ClerkErrorsError45(data=data)
    ...
    def create_allowlist_identifier(
        ...
        *,
        ...
        if utils.match_response(http_res, ["400", "402", "422"], "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsError46Data)
            raise models.ClerkErrorsError46(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
