...
class OrganizationInvitationsSDK(BaseSDK):
    def get_all(
        ...
        *,
        ...
        if utils.match_response(
            ...
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsError44Data)
            raise models.ClerkErrorsError44(data=data)
    ...
    def list(
        ...
        *,
        ...
        if utils.match_response(http_res, ["400", "404"], "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsError74Data)
            raise models.ClerkErrorsError74(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def bulk_create(
        ...
        *,
        ...
        if utils.match_response(
            ...
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsError75Data)
            raise models.ClerkErrorsError75(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def list_pending(
        ...
        *,
        ...
        if utils.match_response(http_res, ["400", "404"], "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsError76Data)
            raise models.ClerkErrorsError76(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def get(
        ...
        *,
        ...
        if utils.match_response(http_res, ["400", "403", "404"], "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsError77Data)
            raise models.ClerkErrorsError77(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def revoke(
        ...
        *,
        ...
        if utils.match_response(http_res, ["400", "403", "404"], "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsError78Data)
            raise models.ClerkErrorsError78(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
