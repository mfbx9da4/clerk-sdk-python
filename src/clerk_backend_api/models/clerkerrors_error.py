...
class ClerkErrorsError104Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError104(Exception):
    r"""Request was not successful"""

    data: ClerkErrorsError104Data

    def __init__(self, data: ClerkErrorsError104Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError104Data)
...
class ClerkErrorsError90Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError90(Exception):
    r"""Resource not found"""

    data: ClerkErrorsError90Data

    def __init__(self, data: ClerkErrorsError90Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError90Data)


class ClerkErrorsError91Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError91(Exception):
    r"""Resource not found"""

    data: ClerkErrorsError91Data

    def __init__(self, data: ClerkErrorsError91Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError91Data)


class ClerkErrorsError92Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError92(Exception):
    r"""Request was not successful"""

    data: ClerkErrorsError92Data

    def __init__(self, data: ClerkErrorsError92Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError92Data)


class ClerkErrorsError93Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError93(Exception):
    r"""Authorization invalid"""

    data: ClerkErrorsError93Data

    def __init__(self, data: ClerkErrorsError93Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError93Data)


class ClerkErrorsError94Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError94(Exception):
    r"""Request was not successful"""

    data: ClerkErrorsError94Data

    def __init__(self, data: ClerkErrorsError94Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError94Data)


class ClerkErrorsError95Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError95(Exception):
    r"""Authorization invalid"""

    data: ClerkErrorsError95Data

    def __init__(self, data: ClerkErrorsError95Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError95Data)


class ClerkErrorsError96Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError96(Exception):
    r"""Authorization invalid"""

    data: ClerkErrorsError96Data

    def __init__(self, data: ClerkErrorsError96Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError96Data)


class ClerkErrorsError97Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError97(Exception):
    r"""Authorization invalid"""

    data: ClerkErrorsError97Data

    def __init__(self, data: ClerkErrorsError97Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError97Data)


class ClerkErrorsError98Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError98(Exception):
    r"""Authorization invalid"""

    data: ClerkErrorsError98Data

    def __init__(self, data: ClerkErrorsError98Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError98Data)


class ClerkErrorsError99Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError99(Exception):
    r"""Payment required"""

    data: ClerkErrorsError99Data

    def __init__(self, data: ClerkErrorsError99Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError99Data)


class ClerkErrorsError100Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError100(Exception):
    r"""Payment required"""

    data: ClerkErrorsError100Data

    def __init__(self, data: ClerkErrorsError100Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError100Data)


class ClerkErrorsError101Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError101(Exception):
    r"""Payment required"""

    data: ClerkErrorsError101Data

    def __init__(self, data: ClerkErrorsError101Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError101Data)


class ClerkErrorsError102Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError102(Exception):
    r"""Payment required"""

    data: ClerkErrorsError102Data

    def __init__(self, data: ClerkErrorsError102Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError102Data)


class ClerkErrorsError103Data(BaseModel):
    errors: List[ClerkError]

    meta: Optional[ClerkErrorsMeta] = None


class ClerkErrorsError103(Exception):
    r"""Payment required"""

    data: ClerkErrorsError103Data

    def __init__(self, data: ClerkErrorsError103Data):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ClerkErrorsError103Data)
