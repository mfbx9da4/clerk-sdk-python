...
class OrganizationInvitationWithPublicOrganizationDataPublicMetadataTypedDict(
    TypedDict
):
    pass
...
class OrganizationInvitationWithPublicOrganizationDataPrivateMetadataTypedDict(
    TypedDict
):
    pass
