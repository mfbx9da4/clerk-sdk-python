...
class SamlConnectionsSDK(BaseSDK):
    def list(
        ...
        *,
        ...
        if utils.match_response(http_res, ["402", "403", "422"], "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsError99Data)
            raise models.ClerkErrorsError99(data=data)
    ...
    def create(
        ...
        *,
        ...
        if utils.match_response(http_res, ["402", "403", "422"], "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsError100Data)
            raise models.ClerkErrorsError100(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def get(
        ...
        *,
        ...
        if utils.match_response(http_res, ["402", "403", "404"], "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsError101Data)
            raise models.ClerkErrorsError101(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def update(
        ...
        *,
        ...
        if utils.match_response(
            ...
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsError102Data)
            raise models.ClerkErrorsError102(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def delete(
        ...
        *,
        ...
        if utils.match_response(http_res, ["402", "403", "404"], "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ClerkErrorsError103Data)
            raise models.ClerkErrorsError103(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError(
                "API error occurred", http_res.status_code, http_res_text, http_res
